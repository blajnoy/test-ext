...
import { setCookie as setCookieAPI, decodeHtml as decodeHtmlAPI, downloader } from '../ext/helper';
...
export default {
  ...
  mounted() {
    chrome.extension.onMessage.addListener(request => {
      ...
      if (request.type === 'failed') {
        ...
        //this.registerExternalDownloadClick({ type: "failed", filename: request.filename, name: request.name });
      } else {
        this.modalType = 'available';
        //app.registerExternalDownloadClick({ type: "failed", filename: request.filename, name: request.name });
      }
  ...
  methods: {
    ...
    addMassMainMusic(elem) {
      ...
      image.src =
        'data:image/png;base64,';

      const btn = document.createElement('a');
      btn.classList.add('downloadButton');
      btn.classList.add('fngfng');
      btn.style =
        'width: 120px;padding: 0 0 0 15px;cursor: pointer;border: none;font-size: 13px;text-decoration: none;display: block;border-radius: 13px;margin-right: 6px;text-align: center;float: left;';
    ...
    addMassAudioButton(elem) {
      ...
      btn.classList.add('fngfng');
      btn.style =
        'width: 100px;background-color: rgb(81, 129, 184);padding: 7px 16px 8px;cursor: pointer;border: none;color: rgb(255, 255, 255);font-size: 13px;text-decoration: none;display: block;border-radius: 13px;margin-top: 6px;text-align: center;';
      ...
      btn.addEventListener('click', function(e) {
        ...
        if (result[1] && result[2]) {
          ...
          downloader.ajax(access + 'vk.com/al_audio.php', 'POST', post, function(response) {
            if (response) {
                ...
                if (json && json.list) {
                  ...
                  for (var i in json.list) {
                    ...
                    if (track) {
                      ...
                      var track_addon = track[13].split('/')[2] + '_' + sec;
                      var obj = { artist: artist, title: name, url: null, album: '', fullId: id, track_addon: track_addon };
